...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . nijaehkk5y
) , 0 , 0 , 80 } , { ( char_T * ) ( & rtDW . ggis1oipis ) , 0 , 0 , 28 } , {
( char_T * ) ( & rtDW . nvizvrqlr5 . LoggedData ) , 11 , 0 , 41 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
PIDController2_D ) , 0 , 0 , 160 } } ; static DataTypeTransitionTable
