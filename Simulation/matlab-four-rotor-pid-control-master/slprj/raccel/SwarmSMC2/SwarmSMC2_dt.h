...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . nkrg0rp1tj
) , 0 , 0 , 268 } , { ( char_T * ) ( & rtDW . d1w1ptz3pi ) , 0 , 0 , 68 } , {
( char_T * ) ( & rtDW . emij3gu2p3 . LoggedData ) , 11 , 0 , 151 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
PIDController2_D ) , 0 , 0 , 560 } } ; static DataTypeTransitionTable
