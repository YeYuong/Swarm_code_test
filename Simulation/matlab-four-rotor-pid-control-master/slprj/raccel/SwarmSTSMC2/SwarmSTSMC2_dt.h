...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . ab333bgofo
) , 0 , 0 , 88 } , { ( char_T * ) ( & rtDW . oqhzpe3pwd ) , 0 , 0 , 28 } , {
( char_T * ) ( & rtDW . niiptouwo3 . LoggedData ) , 11 , 0 , 49 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
PIDController2_D ) , 0 , 0 , 191 } } ; static DataTypeTransitionTable
