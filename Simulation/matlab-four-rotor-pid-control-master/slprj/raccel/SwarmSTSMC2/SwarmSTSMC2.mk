...
MODEL                = SwarmSTSMC2
MODULES              = rt_logging_simtarget.c SwarmSTSMC2.c SwarmSTSMC2_capi.c SwarmSTSMC2_data.c SwarmSTSMC2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = SwarmSTSMC2.exe
MAKEFILE             = SwarmSTSMC2.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SwarmSTSMC2_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/SwarmSTSMC2 \
