...
struct x_posi_ctrl_ty
{
	...
	double u_x; 
	double s_x; 
	double observe_out_pitch; 
	double expect_x_posi_d;
	double expect_x_posi_old;
	double expect_x_posi_dd;
	double expect_x_posi_d_old;
	double err_ESO_x;
	double x1;  //shuchuguance 
	double x2;  //shuchu yijiedao
	double x3;  //raodong
};
...
struct y_posi_ctrl_ty
{
	...
	double u_y;
	double s_y;
	double observe_out_roll;
	double expect_y_posi_d;
	double expect_y_posi_old;
	double expect_y_posi_dd;
	double expect_y_posi_d_old;
	double err_ESO_y;
	double y1;  //shuchuguance 
	double y2;  //shuchu yijiedao
	double y3;  //raodong
};
