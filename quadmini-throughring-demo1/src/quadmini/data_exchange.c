...
/*传感器测试数据*/
	...
	data_pack->data16= global_data.body_ctrl.x_posi_ctrl.expect_x_posi;
	data_pack->data17= global_data.body_ctrl.y_posi_ctrl.expect_y_posi;
	// data_pack->data16= getOpFlowSpeed(OP_X); 
	// data_pack->data17= getOpFlowSpeed(OP_Y);
    // TOF原始数据
	data_pack->data18= getBodyPosition(MC_X);
	data_pack->data19= getBodyPosition(MC_Y);
	...
	data_pack->data31= global_data.body_ctrl.x_posi_ctrl.dot_z_x;
	data_pack->data32= global_data.body_ctrl.y_posi_ctrl.dot_z_y;
	data_pack->data33= global_data.body_ctrl.x_posi_ctrl.z_x;
	data_pack->data34= global_data.body_ctrl.y_posi_ctrl.z_y;
	data_pack->data35= global_data.body_ctrl.x_posi_ctrl.u_x;
	data_pack->data36= global_data.body_ctrl.y_posi_ctrl.u_y;
	data_pack->data37= global_data.body_ctrl.x_posi_ctrl.x_posi_err;
	data_pack->data38= global_data.body_ctrl.y_posi_ctrl.y_posi_err;
	data_pack->data39= global_data.body_ctrl.x_posi_ctrl.x_posi_err_d;
	data_pack->data40= global_data.body_ctrl.y_posi_ctrl.y_posi_err_d;
	data_pack->data41= sign_s(global_data.body_ctrl.x_posi_ctrl.s_x);
	data_pack->data42= sign_s(global_data.body_ctrl.y_posi_ctrl.s_y);
	data_pack->data43= global_data.body_ctrl.x_posi_ctrl.s_x;
	data_pack->data44= global_data.body_ctrl.y_posi_ctrl.s_y;
	data_pack->data45= global_data.body_ctrl.x_posi_ctrl.observe_out_pitch;
	data_pack->data46= global_data.body_ctrl.y_posi_ctrl.observe_out_roll;
	data_pack->data47= global_data.body_ctrl.x_posi_ctrl.x1;
	data_pack->data48= global_data.body_ctrl.y_posi_ctrl.y1;
	data_pack->data49= global_data.body_ctrl.x_posi_ctrl.x3;
	data_pack->data50= global_data.body_ctrl.y_posi_ctrl.y3;
	data_pack->data51= global_data.body_ctrl.x_posi_ctrl.expect_x_posi_dd;
	data_pack->data52= global_data.body_ctrl.y_posi_ctrl.expect_y_posi_dd;
	data_pack->data14= global_data.body_ctrl.x_speed_ctrl.out_pitch;
	data_pack->data15= global_data.body_ctrl.y_speed_ctrl.out_roll;
