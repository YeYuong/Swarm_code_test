...
subplot(2,2,1);
hold on;
plot(x_t, y1, '--', 'DisplayName', 'ISTSM', 'LineWidth', 1, 'Color', [0, 0, 1]);
plot(x_t, y2, 'DisplayName', 'FTESO-ISTSM', 'LineWidth', 1, 'Color', [1, 0, 0]);
grid on;
% title('a(1)');
...
subplot(2,2,2);
hold on;
plot(x_t, y7, '--', 'DisplayName', 'ISTSM', 'LineWidth', 1, 'Color', [0, 0, 1]);
plot(x_t, y8, 'DisplayName', 'FTESO-ISTSM', 'LineWidth', 1, 'Color', [1, 0, 0]);
grid on;
% title('a(2)');
xlabel('time/s','FontWeight', 'bold', 'FontSize', 26);
...
subplot(2,2,3);
hold on;
plot(x_t, y9, '--', 'DisplayName', 'ISTSM', 'LineWidth', 1, 'Color', [0, 0, 1]);
plot(x_t, y10, 'DisplayName', 'FTESO-ISTSM', 'LineWidth', 1, 'Color', [1, 0, 0]);
grid on;
% title('a(3)');
xlabel('time/s','FontWeight', 'bold', 'FontSize', 26);
...
subplot(2,2,4);
hold on;
plot(x_t, y11, '--', 'DisplayName', 'ISTSM', 'LineWidth', 1, 'Color', [0, 0, 1]);
plot(x_t, y12, 'DisplayName', 'FTESO-ISTSM', 'LineWidth', 1, 'Color', [1, 0, 0]);
grid on;
% title('a(4)');
xlabel('time/s','FontWeight', 'bold', 'FontSize', 26);
